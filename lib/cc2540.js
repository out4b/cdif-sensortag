...
util.inherits(CC2540SensorTag, events.EventEmitter);

for (var i in Common.prototype) {
  CC2540SensorTag.prototype[i] = Common.prototype[i];
}
...
CC2540SensorTag.prototype.enableBarometricPressure = function(callback) {
  this.writeUInt8Characteristic(BAROMETRIC_PRESSURE_UUID, BAROMETRIC_PRESSURE_CONFIG_UUID, 0x02, function(error) {
    ...
    this.device.readDataCharacteristic(BAROMETRIC_PRESSURE_UUID, BAROMETRIC_PRESSURE_CALIBRATION_UUID, function(error, data) {
      if (error) {
        return callback(error);
      }
...
CC2540SensorTag.prototype.readAccelerometer  = function(callback) {
  this.device.readDataCharacteristic(ACCELEROMETER_UUID, ACCELEROMETER_DATA_UUID, function(error, data) {
    if (error) {
      return callback(error);
    }
...
CC2540SensorTag.prototype.notifyAccelerometer = function(callback) {
  this.device.notifyCharacteristic(ACCELEROMETER_UUID, ACCELEROMETER_DATA_UUID, true, this.onAccelerometerChangeBinded, callback);
};

CC2540SensorTag.prototype.unnotifyAccelerometer = function(callback) {
  this.device.notifyCharacteristic(ACCELEROMETER_UUID, ACCELEROMETER_DATA_UUID, false, this.onAccelerometerChangeBinded, callback);
};
...
CC2540SensorTag.prototype.readMagnetometer = function(callback) {
  this.device.readDataCharacteristic(MAGNETOMETER_UUID, MAGNETOMETER_DATA_UUID, function(error, data) {
    if (error) {
      return callback(error);
    }
...
CC2540SensorTag.prototype.notifyMagnetometer = function(callback) {
  this.device.notifyCharacteristic(MAGNETOMETER_UUID, MAGNETOMETER_DATA_UUID, true, this.onMagnetometerChangeBinded, callback);
};

CC2540SensorTag.prototype.unnotifyMagnetometer = function(callback) {
  this.device.notifyCharacteristic(MAGNETOMETER_UUID, MAGNETOMETER_DATA_UUID, false, this.onMagnetometerChangeBinded, callback);
};
...
CC2540SensorTag.prototype.readGyroscope = function(callback) {
  this.device.readDataCharacteristic(GYROSCOPE_UUID, GYROSCOPE_DATA_UUID, function(error, data) {
    if (error) {
      return callback(error);
    }
...
CC2540SensorTag.prototype.notifyGyroscope = function(callback) {
  this.device.notifyCharacteristic(GYROSCOPE_UUID, GYROSCOPE_DATA_UUID, true, this.onGyroscopeChangeBinded, callback);
};

CC2540SensorTag.prototype.unnotifyGyroscope = function(callback) {
  this.device.notifyCharacteristic(GYROSCOPE_UUID, GYROSCOPE_DATA_UUID, false, this.onGyroscopeChangeBinded, callback);
};
