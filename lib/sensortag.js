...
var SensorTag = function(bleDevice) {
  ...
  var service;
  if (isCC2650) {
    this.setAction('urn:cdif-net:serviceID:Illuminance', 'getIlluminanceData', getLuxometerData.bind(this));
  ...
  this.setAction('urn:cdif-net:serviceID:Temperature', 'getTemperatureData', getTemperatureData.bind(this));
  ...
  this.setAction('urn:cdif-net:serviceID:Accelerometer', 'getAccelerometerData', getAccelerometerData.bind(this));
  ...
  this.setAction('urn:cdif-net:serviceID:Humidity', 'getHumidityData', getHumidityData.bind(this));
  ...
  this.setAction('urn:cdif-net:serviceID:Magnetometer', 'getMagnetometerData', getMagnetometerData.bind(this));
  ...
  this.setAction('urn:cdif-net:serviceID:Barometer', 'getBarometerData', getBarometerData.bind(this));
  ...
  this.setAction('urn:cdif-net:serviceID:Gyroscope', 'getGyroscopeData', getGyroscopeData.bind(this));
